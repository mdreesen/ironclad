...
import { _ as __nuxt_component_2$1, a as __nuxt_component_3 } from './Table-EqLVQtts.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<h2${ssrRenderAttrs(mergeProps({ class: "text-4xl tracking-tighter font-bold text-normal flex justify-center mb-2" }, _attrs))}>${__props.label ?? ""}</h2>`);
    };
  }
});
...
const __nuxt_component_2 = Object.assign(_sfc_main$1, { __name: "BaseHeaderSection" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_baseCard = __nuxt_component_2$1;
      const _component_baseTable = __nuxt_component_3;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col gap-20" }, _attrs))}><header class="flex justify-between items-center"><div><span class="font-medium text-xs uppercase tracking-widest">Company Name</span>`);
      _push(ssrRenderComponent(_component_baseHeader, { label: "First Name" }, null, _parent));
      _push(`</div><div class="flex gap-4">`);
      _push(ssrRenderComponent(_component_baseButton, { label: "New Entry" }, null, _parent));
      _push(`</div></header><section class="bg-gray-700/50 p-2">`);
      ...
      _push(`<!--]--></div></section><section class="bg-gray-700/50 p-2">`);
      _push(ssrRenderComponent(_component_baseHeaderSection, { label: "CLIENTS & LEADS" }, null, _parent));
...
//# sourceMappingURL=index-BICFmq2n.mjs.map
