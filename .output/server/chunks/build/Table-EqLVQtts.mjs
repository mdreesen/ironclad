import { a as _sfc_main$4 } from './Card-Dw3ko20Y.mjs';
import { defineComponent, mergeProps, withCtx, createVNode, toDisplayString, createTextVNode, ref, isRef, unref, useSlots, computed, useTemplateRef, renderSlot, openBlock, createBlock, createCommentVNode, useModel, toRef, watch, Fragment, renderList, mergeModels, h, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrInterpolate, ssrRenderAttrs, ssrRenderSlot, ssrRenderClass, ssrRenderAttr, ssrRenderStyle, ssrRenderList } from 'vue/server-renderer';
import { _ as _sfc_main$5 } from './Badge-CUSlNkxB.mjs';
import { d as useAppConfig, e as useComponentUI, f as useFormField, g as useFieldGroup, h as useComponentIcons, t as tv, P as Primitive, i as _sfc_main$e, j as _sfc_main$b, k as useLocale, m as useForwardProps, l as looseToNumber } from './server.mjs';
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UCard, mergeProps({ class: "bg-gray-700/50" }, _attrs), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div${_scopeId}><div${_scopeId}>${ssrInterpolate(__props.description)}</div><span${_scopeId}>${ssrInterpolate(__props.status)}</span></div>`);
          } else {
            return [
...
const __nuxt_component_2 = Object.assign(_sfc_main$3, { __name: "BaseCard" });
const theme$1 = {
  "slots": {
...
//# sourceMappingURL=Table-EqLVQtts.mjs.map
