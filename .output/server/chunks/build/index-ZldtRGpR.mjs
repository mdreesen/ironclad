...
import { _ as __nuxt_component_2, a as __nuxt_component_1, b as __nuxt_component_3 } from './Table-C3zb5ajf.mjs';
import * as cpexcel from '/Users/mdreesen/Documents/Programming/business-projects/ironclad/node_modules/xlsx/dist/cpexcel.js';
...
const __nuxt_component_0 = Object.assign(_sfc_main$1, { __name: "BaseLink" });
const downloadExcel = (data) => {
  const worksheet = xlsxExports.utils.json_to_sheet(data);
  const workbook = xlsxExports.utils.book_new();
  xlsxExports.utils.book_append_sheet(workbook, worksheet, "Invoices");
  xlsxExports.writeFile(workbook, "Ironclad_Financial_Report.xlsx");
};
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><header class="max-w-7xl mx-auto mb-16"><div class="flex justify-between items-end mb-12"><div><span class="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-400 block mb-2">Financial Records</span><h1 class="text-5xl font-black uppercase italic tracking-tighter">Ironclad <span class="text-zinc-200 text-normal">Ledger.</span></h1></div>`);
      ...
      _push(`</div></header><main class="max-w-7xl mx-auto"><div class="border border-zinc-200 rounded-sm shadow-sm overflow-hidden"><div class="p-6 border-b border-zinc-100 flex justify-between items-center bg-zinc-50/30"><input type="text" placeholder="Search by client or project..." class="bg-transparent border-none outline-none text-sm font-medium w-full max-w-md placeholder:text-zinc-300"><div class="flex gap-4"><button class="text-[10px] font-bold uppercase tracking-widest text-zinc-400 hover:text-zinc-950 transition-colors">Filters</button>`);
      _push(ssrRenderComponent(_component_baseButton, {
        onClick: unref(downloadExcel),
        label: "Export"
      }, null, _parent));
      _push(`</div></div>`);
...
//# sourceMappingURL=index-ZldtRGpR.mjs.map
