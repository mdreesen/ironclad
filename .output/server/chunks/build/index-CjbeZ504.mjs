...
import { defineComponent, ref, mergeProps, computed, unref, withCtx, createVNode, renderSlot, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, Fragment, renderList, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderSlot, ssrInterpolate, ssrRenderClass, ssrRenderList } from 'vue/server-renderer';
import { R as RangeCalendar, C as Calendar, g as getWeekNumber } from './index-CMxUnq-8.mjs';
import { u as useLocale, a as useAppConfig, b as useComponentUI, c as useForwardPropsEmits, t as tv, _ as _sfc_main$8 } from './server.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UCalendar, mergeProps({ "number-of-months": 3 }, _attrs), null, _parent));
    };
  }
});
...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-5df07dbf"]]), { __name: "BaseCalendar" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[-->`);
      _push(ssrRenderComponent(_component_appHero, { label: "Calendar" }, null, _parent));
...
//# sourceMappingURL=index-CjbeZ504.mjs.map
