...
import { defineComponent, h, useSlots, ref, inject, computed, mergeProps, unref, withCtx, renderSlot, openBlock, createBlock, createCommentVNode, toDisplayString, createVNode, toValue, resolveDynamicComponent, watch, toRef, getCurrentInstance, camelize, useTemplateRef, Comment, cloneVNode, shallowRef, resolveComponent, provide, useModel, createTextVNode, mergeModels, isRef, hasInjectionContext, Fragment, onServerPrefetch, defineAsyncComponent, nextTick, toRefs, reactive, createElementBlock, useSSRContext, Suspense, createApp, renderList, useId as useId$1, shallowReactive, onErrorCaptured, effectScope, withModifiers, normalizeProps, guardReactiveProps, watchEffect, normalizeStyle, toHandlers, createSlots, getCurrentScope, markRaw, Teleport, withKeys, toHandlerKey, watchSyncEffect, watchPostEffect, mergeDefaults, isReadonly, isShallow, isReactive, toRaw } from 'vue';
...
import { reactivePick, useVModel, reactiveOmit, useDebounceFn, createSharedComposable, useEventListener, unrefElement, createGlobalState, defaultWindow, createReusableTemplate, onKeyStroke, useMounted, useRafFn, computedEager } from '@vueuse/core';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BErRqK9n.mjs')
  }
];
    ...
    default: withCtx(({ open }, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_UButton, {
          ...
          size: "xs",
          class: ["-mb-1.5 font-semibold rounded-full truncate", [open && "bg-primary/15"]],
          ui: {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-ClC594dV.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-dAd1u4Ln.mjs'));
...
export { Primitive as P, _export_sfc as _, __nuxt_component_0$1 as a, _sfc_main$n as b, useAppConfig as c, useComponentUI as d, entry_default as default, useFieldGroup as e, useComponentIcons as f, _sfc_main$s as g, _sfc_main$q as h, useLocale as i, useForwardProps as j, _sfc_main$b as k, tv as t, useHead as u };
