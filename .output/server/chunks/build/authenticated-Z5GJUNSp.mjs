...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main class="p-8 min-h-screen">`);
...
//# sourceMappingURL=authenticated-Z5GJUNSp.mjs.map
