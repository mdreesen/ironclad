...
import { c as useRoute, u as useHead, _ as __nuxt_component_1$1, k as useLocale, d as useAppConfig, e as useComponentUI, J as getSlotChildrenText, t as tv, a as _sfc_main$8$1, K as _sfc_main$9$1, P as Primitive, F as useForwardPropsEmits, L as isArrayOfArray, j as _sfc_main$b, M as _sfc_main$c, i as _sfc_main$e, N as get, O as pickLinkProps, Q as _sfc_main$a$1, I as usePortal, V as VisuallyHidden_default, r as useForwardExpose, G as useCollection, H as injectTooltipProviderContext, v as Presence_default, D as useEmitAsProps, T as Teleport_default, s as createContext, q as injectConfigProviderContext, w as getActiveElement, m as useForwardProps, p as isNullish, A as AUTOFOCUS_ON_MOUNT, x as focusFirst$1, y as getTabbableCandidates$1, z as focus, B as AUTOFOCUS_ON_UNMOUNT, E as EVENT_OPTIONS, C as getTabbableEdges } from './server.mjs';
import { k as defu, o as isEqual } from '../nitro/nitro.mjs';
...
import { _ as _sfc_main$a, p as pointerDownOutside } from './Drawer-z6KTOjzW.mjs';
import { _ as _sfc_main$d } from './Badge-CUSlNkxB.mjs';
        ...
        title: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="text-2xl font-bold"${_scopeId2}> IRONCLAD </span>`);
                } else {
                  return [
                    createVNode("span", { class: "text-2xl font-bold" }, " IRONCLAD ")
                  ];
                }
              }),
              _: 1
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "p-8 min-h-screen" }, _attrs))}>`);
...
//# sourceMappingURL=authenticated-ciNc_0a9.mjs.map
