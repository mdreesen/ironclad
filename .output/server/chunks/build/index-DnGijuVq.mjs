...
import { defineComponent, ref, mergeProps, withCtx, createVNode, toDisplayString, computed, unref, renderSlot, createTextVNode, openBlock, createBlock, createCommentVNode, Fragment, renderList, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderList, ssrRenderAttrs, ssrInterpolate, ssrRenderSlot, ssrRenderClass } from 'vue/server-renderer';
import { R as RangeCalendar, C as Calendar, g as getWeekNumber } from './index-fuea8ytG.mjs';
import { u as useLocale, b as useAppConfig, c as useComponentUI, d as useForwardPropsEmits, t as tv, e as _sfc_main$8 } from './server.mjs';
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    ref([
      { date: 15, client: "WHITEFISH LAKE", task: "Slab Pour", team: "THORNE", status: "ACTIVE" },
      { date: 16, client: "KALISPELL COMM.", task: "Framing", team: "VANE", status: "PENDING" },
      { date: 18, client: "BIGFORK CABIN", task: "Finishing", team: "RODRIGUEZ", status: "DISPATCHED" }
    ]);
    const daysInMonth = new Date(year, currentDate.getMonth() + 1, 0).getDate();
    Array.from({ length: daysInMonth }, (_, i) => i + 1);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UCalendar = _sfc_main$4;
      _push(ssrRenderComponent(_component_UCalendar, _attrs, null, _parent));
    };
  }
});
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/base/Calendar.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$3, [["__scopeId", "data-v-16ac24e7"]]), { __name: "BaseCalendar" });
...
const __nuxt_component_2 = Object.assign(_sfc_main$2, { __name: "BaseHeaderSection" });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UPageCard, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex flex-col text-[15px] text-pretty text-muted mt-1"${_scopeId}><span${_scopeId}>${ssrInterpolate(__props.date)}</span><span${_scopeId}>${ssrInterpolate(__props.time)}</span></div><div class="flex gap-4"${_scopeId}>`);
            ...
            return [
              createVNode("div", { class: "flex flex-col text-[15px] text-pretty text-muted mt-1" }, [
                createVNode("span", null, toDisplayString(__props.date), 1),
                createVNode("span", null, toDisplayString(__props.time), 1)
              ]),
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/base/CardSchedule.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const __nuxt_component_3 = Object.assign(_sfc_main$1, { __name: "BaseCardSchedule" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "index",
  __ssrInlineRender: true,
  setup(__props) {
    const scheduled = [
      { id: 123456, name: "frank", time: "01:30pm", date: "02/02/2026", phone: "4066072405", email: "mdreesen90@gmail.com" },
      { id: 123457, name: "Billy", time: "01:30pm", date: "02/05/2026", phone: "4066072405", email: "mdreesen90@gmail.com" },
      { id: 123458, name: "Tank", time: "01:30pm", date: "02/09/2026", phone: "4066072405", email: "mdreesen90@gmail.com" },
      { id: 123459, name: "Lile", time: "01:30pm", date: "02/01/2026", phone: "4066072405", email: "mdreesen90@gmail.com" },
      { id: 123451, name: "Jessica", time: "01:30pm", date: "02/26/2026", phone: "4066072405", email: "mdreesen90@gmail.com" }
    ];
    return (_ctx, _push, _parent, _attrs) => {
      const _component_appHero = __nuxt_component_0;
      const _component_baseCalendar = __nuxt_component_1;
      const _component_baseHeaderSection = __nuxt_component_2;
      const _component_baseCardSchedule = __nuxt_component_3;
      _push(`<!--[-->`);
      _push(ssrRenderComponent(_component_appHero, { label: "Schedule" }, null, _parent));
      _push(`<main class="flex flex-col gap-16"><section>`);
      _push(ssrRenderComponent(_component_baseCalendar, null, null, _parent));
      _push(`</section><section>`);
      _push(ssrRenderComponent(_component_baseHeaderSection, { label: "SCHEDULED FOR TODAY" }, null, _parent));
      _push(`<div class="flex flex-wrap justify-center gap-5"><!--[-->`);
      ssrRenderList(scheduled, (item) => {
        _push(`<div>`);
        _push(ssrRenderComponent(_component_baseCardSchedule, {
          label: item.name,
...
//# sourceMappingURL=index-DnGijuVq.mjs.map
